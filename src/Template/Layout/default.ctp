...
$cakeDescription = 'Laboratorio de Control y Automtización';
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <nav class="top-bar expanded" data-topbar role="navigation">
        ...
        <div class="top-bar-section">
            <ul class="right">
                ...
                <li><?= $this->Html->link('Gestión de Inventario',['controller' => 'Items', 'action' => 'index']); ?></li>
                <li><?= $this->Html->link('Gestión de Usuarios',['controller' => 'users', 'action' => 'index']); ?></li>
                <li><?= $this->Html->link('Nuevo Item',['controller' => 'items', 'action' => 'add']); ?></li>
